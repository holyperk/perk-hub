...
local function RequestAuth(key)
    ...
    -- Some executor HTTP layers report a misleading status code even when
    -- the response body from the Worker is valid. Validate the body first.
